...
import { idlFactory } from './ic_dao_frontend.did.js';
export { idlFactory } from './ic_dao_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.IC_DAO_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_dao_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_dao_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_dao_frontend.did.js")._SERVICE>}
 */
export const ic_dao_frontend = createActor(canisterId);
