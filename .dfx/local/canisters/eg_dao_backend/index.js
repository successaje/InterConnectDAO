...
import { idlFactory } from './ic_dao_backend.did.js';
export { idlFactory } from './ic_dao_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ic_dao_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_dao_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_dao_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_dao_backend.did.js")._SERVICE>}
 */
export const ic_dao_backend = createActor(canisterId);
