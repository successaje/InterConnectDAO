...
import { idlFactory } from './icdao.did.js';
export { idlFactory } from './icdao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICDAO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icdao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icdao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icdao.did.js")._SERVICE>}
 */
export const icdao = createActor(canisterId);
